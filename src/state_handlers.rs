...
",
    ...
    #[test]
    fn guard_rejects_missing_tests_stub() {
        ...
        let should_guard = ctx.repair_attempts > 0
        ...
        assert!(
            should_guard,
            "Guard should trigger when MissingTests was repaired but mutation found nothing"
        );
    }

    #[test]
    fn guard_allows_normal_success() {
        ...
        assert!(
            !should_guard,
            "Guard should NOT trigger when no repair happened"
        );
    }
}
